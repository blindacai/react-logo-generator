    ...
    render(){
        return(
            <div className="svg-container">
                <svg id="logo-svg" version="1.1"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 600 600" enable-background="new 0 0 600 600">
                ...
                <div className="downloadLinks">
                    <a id="downloadLink" className="downloadLink button">Download SVG</a>
                    <a id="downloadLinkForImage" className="downloadLink button">Download Image</a>
                </div>
